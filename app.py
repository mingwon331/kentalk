...
# 6. 간편식(샐러드) 빌더
# =========================
# 행 인덱스 (0-based): 1행은 요일 헤더, 2행=조식, 3행=중식, 4행=석식
SALAD_MEAL_ROW = {
    "breakfast": 1,
    "lunch":     2,
    "dinner":    3,
